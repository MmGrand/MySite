            ...
            <div class="container mx-auto px-4">
                <div class="max-w-md mx-auto bg-gray-100 shadow-lg rounded-lg p-6">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <a href="{{ route('password.request.form') }}"
                                class="text-sm text-blue-600 hover:underline">{{ __('Забыли пароль?') }}</a>
                        </div>
                    ...
                    <div class="text-center mt-4">
                        <p class="text-gray-600">{{ __('Еще нет аккаунта?') }} <a href="{{ route('register') }}"
                                class="text-blue-600 hover:underline">{{ __('Зарегистрироваться') }}</a></p>
                    </div>
                </div>
            </div>
        </section>
